# 👨‍💻 Gabriel Vieira Correa

**`Estudante de Engenharia de Controle e Automação`**

Eu me chamo Gabriel Vieira Correa, tenho 20 anos e sou natural do Rio de Janeiro. Atualmente, estou cursando Engenharia de Controle e Automação na POLI-UPE. Atualmente estou focado em aprender C e C++, entendendo a fundo o funcionamento de baixo nível, ponteiros e gerenciamento de memória. Além disso, estou me aprofundando no ecossistema Linux, explorando comandos, ferramentas e o desenvolvimento voltado para esse ambiente
